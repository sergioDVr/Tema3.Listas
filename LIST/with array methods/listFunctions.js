...
function testList() {
    ...
    console.log(list);
    console.log("Añadimos otro elemento en la posicion 0, un 50: " + addAt(list, 50, 0));
    console.log("Añadimos otro elemento en la posicion 2, un 100: " + addAt(list, 100, 2));
    console.log(list);
    ...
    console.log(list);
    console.log("Set position 1 by 333") + set(list, 333, 0);
    console.log(list);
